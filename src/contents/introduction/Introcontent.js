...
const Introcontent = () => (
    <div className="container mt-5 introduction">
		<div className="row">
			<div className="col-12 col-md-9 order-md-1 order-2 text-center text-md-start text-container">
				...
				<p>My skill set extends to building responsive, user-centric web and mobile applications, demonstrated through 
					multiple internships and personal projects. Whether I’m working on high-level interfaces or optimizing low-level 
					system performance, I am committed to delivering well-structured, functional, and scalable solutions. I am eager 
					to collaborate on innovative projects that challenge the boundaries of software development and enhance users' 
		    ...
		    <div className="col-12 col-md-3 order-md-2 order-1 text-center img-container">
			    <img className="mypicture" src={self} alt="a smiling sayyidah akindele"></img>
		    </div>
	    </div>
	</div>
);
